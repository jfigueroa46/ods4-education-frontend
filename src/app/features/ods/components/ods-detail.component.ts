...
@Component({
  ...
  template: `
    <div class="page-header fade-in">
      <div><p class="text-muted mb-0" style="font-size:0.8rem">ODS</p><h2>Detalle ODS</h2></div>
      <div class="d-flex gap-2">
        <a [routerLink]="['/ods/edit', ods?.id]" class="btn btn-primary"><i class="bi bi-pencil me-1"></i>Editar</a>
    ...
    <div class="card fade-in" style="max-width:580px" *ngIf="ods">
      ...
      <div class="card-body">
        <dl class="row mb-0">
          ...
          <dt class="col-sm-4 text-muted" style="font-size:0.8rem">Número</dt><dd class="col-sm-8">{{ ods.odsNumber }}</dd>
          <dt class="col-sm-4 text-muted" style="font-size:0.8rem">Nombre</dt><dd class="col-sm-8 fw-semibold">{{ ods.odsName }}</dd>
          <dt class="col-sm-4 text-muted" style="font-size:0.8rem">Descripción</dt><dd class="col-sm-8">{{ ods.description || '—' }}</dd>
        </dl>
      </div>
    </div>
